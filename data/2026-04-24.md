...
### [1] [Spectral Kernel Dynamics for Planetary Surface Graphs: Distinction Dynamics and Topological Conservation](https://arxiv.org/abs/2604.20887)
*Jnaneshwar Das*
...
### [2] [Collisionless Phase Mixing Mimics Diffusive Transport in Radiation Belt Observations](https://arxiv.org/abs/2604.21427)
...
### [3] [Planetary Exploration 3.0: A Roadmap for Software-Defined, Radically Adaptive Space Systems](https://arxiv.org/abs/2604.20910)
...
### [4] [Turbulent infall onto class 0 disks as cause of CAI brief condensation episode in the solar system](https://arxiv.org/abs/2604.21322)
...
### [5] [MINDS: Intertwined evolution of dust and gas in large planet-forming disks. A diversity driven by halted pebble drift?](https://arxiv.org/abs/2604.21803)
...
### [6] [Toward Inferring the Surface Fluxes of Biosignature Gases on Rocky Exoplanets from Telescope Spectra](https://arxiv.org/abs/2604.21848)
...
### [8] [Properties and Radial Evolution of Solar Wind Turbulence Near Mercury's Orbit](https://arxiv.org/abs/2604.21196)
